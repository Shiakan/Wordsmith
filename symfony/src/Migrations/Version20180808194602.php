 ...
 */
final class Version20180808194602 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, thread_id INT NOT NULL, content LONGTEXT NOT NULL, status TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), INDEX IDX_5A8A6C8DE2904019 (thread_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(128) NOT NULL, content LONGTEXT NOT NULL, slug VARCHAR(128) DEFAULT NULL, date_inserted DATETIME NOT NULL, status TINYINT(1) NOT NULL, INDEX IDX_23A0E66F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE article_tag (article_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_919694F97294869C (article_id), INDEX IDX_919694F9BAD26311 (tag_id), PRIMARY KEY(article_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE thread (id INT AUTO_INCREMENT NOT NULL, subcategory_id INT NOT NULL, author_id INT NOT NULL, title VARCHAR(256) NOT NULL, subtitle VARCHAR(256) DEFAULT NULL, status TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_31204C835DC6FE57 (subcategory_id), INDEX IDX_31204C83F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE character_profile (id INT AUTO_INCREMENT NOT NULL, group_forum_id INT DEFAULT NULL, rank_id INT DEFAULT NULL, avatar VARCHAR(255) NOT NULL, age VARCHAR(32) DEFAULT NULL, race VARCHAR(128) DEFAULT NULL, class VARCHAR(128) DEFAULT NULL, social_cast VARCHAR(128) DEFAULT NULL, localisation VARCHAR(128) DEFAULT NULL, miscellaneous LONGTEXT DEFAULT NULL, link1 VARCHAR(255) DEFAULT NULL, link2 VARCHAR(255) DEFAULT NULL, INDEX IDX_E8F22A3220FCF6AF (group_forum_id), INDEX IDX_E8F22A327616678F (rank_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE subcategory (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, name VARCHAR(256) NOT NULL, INDEX IDX_DDCA44812469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
